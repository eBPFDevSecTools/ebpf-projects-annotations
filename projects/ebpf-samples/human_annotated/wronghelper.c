 ...
 OPENED COMMENT BEGIN 
{
  ...
  "startLine": 29,
  "endLine": 37,
  "File": "/root/examples/ebpf-samples/wronghelper.c",
  "funcName": "func",
  "updateMaps": [
    " ctx"
  ],
  ...
  "humanFuncDescription": [
    {
      "description": "The function func() takes ctx of type void* as input parameter.
                      ...
                      The function will fail because the type of the ctx is not struct bpf_sock_ops.",
