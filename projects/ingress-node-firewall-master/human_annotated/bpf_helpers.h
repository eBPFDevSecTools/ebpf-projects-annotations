 ...
 OPENED COMMENT BEGIN 
{
  ...
  "startLine": 135,
  "endLine": 160,
  "File": "/home/sayandes/ebpf-projects-annotations/projects/ingress-node-firewall-master/original_source/bpf/headers/bpf_helpers.h",
  ...
  "developer_inline_comments": [
    ...
    },
    {
      "start_line": 5,
      "end_line": 10,
      "text": " * Note that bpf programs need to include either * vmlinux.h (auto-generated from BTF) or linux/types.h * in advance since bpf_helper_defs.h uses such types * as __u64. "
    },
    {
      "start_line": 17,
      "end_line": 24,
      "text": " * Helper macro to place programs, maps, license in * different sections in elf_bpf file. Section names * are interpreted by libbpf depending on the context (BPF programs, BPF maps, * extern variables, etc). * To allow use of SEC() with externs (e.g., for extern .maps declarations), * make sure __attribute__((unused)) doesn't trigger compilation warning. "
    },
    {
      "start_line": 27,
      "end_line": 31,
      "text": " * Pragma macros are broken on GCC * https:gcc.gnu.org/bugzilla/show_bug.cgi?id=55578 * https:gcc.gnu.org/bugzilla/show_bug.cgi?id=90400 "
    },
    {
      "start_line": 44,
      "end_line": 44,
