 ...
 OPENED COMMENT BEGIN 
{
  ...
  "startLine": 34,
  "endLine": 139,
  "File": "/home/sayandes/ebpf-projects-annotations/examples/katran/healthchecking_kern.c",
  ...
  "developer_inline_comments": [
    ...
    },
    {
      "start_line": 75,
      "end_line": 75,
      "text": "// we dont have ifindex for main interface"
    },
    {
      "start_line": 76,
      "end_line": 76,
    ...
    },
    {
      "start_line": 108,
      "end_line": 108,
      "text": "// to prevent recursion, if encapsulated packet would run through this filter"
    }
  ],
  "updateMaps": [],
  "readMaps": [
