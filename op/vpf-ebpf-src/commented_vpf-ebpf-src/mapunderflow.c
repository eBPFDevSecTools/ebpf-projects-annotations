 ...
 OPENED COMMENT BEGIN 
{
  ...
  "startLine": 29,
  "endLine": 38,
  "File": "/home/sayandes/ebpf-projects-annotations/examples/vpf-ebpf-src/mapunderflow.c",
  "funcName": "func",
  "developer_inline_comments": [
    ...
    },
    {
      "start_line": 35,
      "end_line": 35,
      "text": "// write before the start of the array, or past the end if -1"
    },
    {
      "start_line": 36,
      "end_line": 36,
      "text": "// is interpreted as unsigned."
    }
  ],
  "updateMaps": [
    " map"
