...
def update_ai_func_description(comments_db,comment_dict):
    ...
    ai_comments = comment_dict[ai_func_desc_key]
    json_str = json.dumps(ai_comments)

    print("AI Comments JSON: "+json_str)
    q = Query()
